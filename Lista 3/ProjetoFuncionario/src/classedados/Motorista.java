...
public class Motorista extends Funcionario implements IFuncionario{
//Construtor
    public Motorista(){}
    public Motorista(String nomeDoCooperado, String profissaoDoCooperado, float numerosDeHorasTrabalhadasNoMes, float valorDaHoraDeTrabalho, float salarioDoMes, int numeroDeFilhos) throws Exception {
    ...
    public Motorista(Motorista objeto) throws Exception {
        super(objeto);
    }
