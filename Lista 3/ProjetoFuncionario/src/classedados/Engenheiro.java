...
public class Engenheiro extends Funcionario implements IFuncionario{
    //Construtor
    public Engenheiro(){}
    public Engenheiro(String nomeDoCooperado, String profissaoDoCooperado, float numerosDeHorasTrabalhadasNoMes, float valorDaHoraDeTrabalho, float salarioDoMes, int numeroDeFilhos) throws Exception {
    ...
    public Engenheiro(Engenheiro objeto) throws Exception {
        super(objeto);
    }
