...
public class TelaPincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PROGRAMA DA CLASSE CILINDRO");
    ...
    private void jButtonExecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExecutarActionPerformed
        if(!(jTextFieldRaio.getText().equals("")||jTextFieldAltura.getText().equals(""))){
            try {
                ...
                cubo.setAltura(Float.parseFloat(jTextFieldRaio.getText()));
                cubo.setRaio(Float.parseFloat(jTextFieldAltura.getText()));
