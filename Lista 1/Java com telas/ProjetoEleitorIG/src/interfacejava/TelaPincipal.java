...
public class TelaPincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldAnoDoNascimento = new javax.swing.JTextField();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Projeto Eleitor");
        setLocation(new java.awt.Point(600, 350));
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel1.setText("PROGRAMA DA CLASSE ELEITOR");
        ...
        jLabel3.setText("ANO DO NASCIMENTO:");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jTextFieldAnoDoNascimento, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(0, 0, Short.MAX_VALUE))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(jTextFieldAnoDoNascimento, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(2, 2, 2)
    ...
    private void jButtonExecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExecutarActionPerformed
        if(!(jTextFieldNome.getText().equals("")||jTextFieldAnoDoNascimento.getText().equals(""))){
            try {
                //Validação se á numeros decimais no ano de nascimento
                double x = Double.parseDouble(jTextFieldAnoDoNascimento.getText());
                if(x%1 > 0) throw new Exception ("Ano de nascimento não pode ser decimal.");
                ...
                povo.setAnoDeNascimento(Integer.parseInt(jTextFieldAnoDoNascimento.getText()));
    ...
    private javax.swing.JTextField jTextFieldAnoDoNascimento;
