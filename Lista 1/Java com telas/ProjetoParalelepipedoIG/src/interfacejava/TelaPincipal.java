...
public class TelaPincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PROGRAMA DA CLASSE PARALELEPÍPEDO");
    ...
    private void jButtonExecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExecutarActionPerformed
        if(!(jTextFieldLargura.getText().equals("")||jTextFieldAltura.getText().equals("")||jTextFieldComprimento.getText().equals(""))){
            try {
                //Instancia
                Paralelepipedo pedo = new Paralelepipedo();

                pedo.setComprimento(Float.parseFloat(jTextFieldComprimento.getText()));
                pedo.setAltura(Float.parseFloat(jTextFieldAltura.getText()));
                pedo.setLargura(Float.parseFloat(jTextFieldLargura.getText()));
