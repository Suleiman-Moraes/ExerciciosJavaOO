...
public class TelaPincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PROGRAMA DA CLASSE CONE");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jTextFieldAltura, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(66, 66, 66)))
    ...
    private void jButtonExecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExecutarActionPerformed
        if(!(jTextFieldRaio.getText().equals("")||jTextFieldAltura.getText().equals(""))){
            try {
                //Instancia
                Cone fred = new Cone();

                fred.setAltura(Float.parseFloat(jTextFieldAltura.getText()));
                fred.setRaio(Float.parseFloat(jTextFieldRaio.getText()));
